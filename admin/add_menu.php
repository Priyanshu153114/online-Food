					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO dishes(rs_id,title,slogan,price,img) VALUE('".$_POST['res_name']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".RSfnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                    ...
                    <footer class="footer"> © 2023 - Restaurant Mangement System - Developed by Priyanshu & Vishal </footer>
                </div>               
            </div>
        </div>    
    </div>
